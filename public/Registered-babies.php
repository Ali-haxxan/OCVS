...
<head>
  ...
  <title>Online Child Vaccination System</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"><div>{{ Auth::guard('front')->user()->name }}</div></a>
        </div>
      </div>
        ...
        <h2 class="title">Registration Form</h2>
                    <form method="POST">
                        <div class="row row-space">
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Baby name</label>
                        ...
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Father CNIC</label>
                                    <input class="input--style-4" type="text" name="last_name">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    <label class="label">Mother CNIC</label>
                                    <input class="input--style-4" type="text" name="last_name">
                                </div>
                            </div>
                        </div>
                        <div class="row row-space">
                            ...
                            <div class="col-2">
                                <div class="input-group">
                                    ...
                                    <input class="input--style-4" type="Address" name="email">
                                </div>
                            </div>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2014-2022 <a href="#">Online Child Vaccination System</a>.</strong>
    All rights reserved.
